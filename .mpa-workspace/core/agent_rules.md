...
(`workspace/project_memory/shared/architecture.md` 코드 맵, MCP, grep 등 활용)

탐색 후 두 가지를 기록한다:
- 작업 대상 파일 목록 → `plan.md`
- 새로 발견한 파일 관계 → `workspace/project_memory/shared/architecture.md` 코드 맵 섹션
...
해당 내용은 `workspace/project_memory/roles/[페르소나명].md`에 직접 작성한다.  
다른 역할의 파일은 수정하지 않는다.
