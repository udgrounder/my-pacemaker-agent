...
4. `workspace/project_memory/roles/architect.md` (존재하는 경우) — 이 프로젝트에서 architect 역할이 축적한 학습
...
1. 새로운 아키텍처 결정 → `workspace/project_memory/shared/architecture.md`
2. 태스크 계획 저장 → `workspace/tasks/active/[태스크명]/plan.md`
   - **상태를 `설계 완료`로 표시**
   - `에이전트 보고` 섹션을 채운다:
