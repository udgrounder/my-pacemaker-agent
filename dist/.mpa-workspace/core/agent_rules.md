...
| 계획 비평 (새 스레드) | — | `inject/layer1_critique.md` |
...
| 상황 | 예시 힌트 |
|------|---------|
| plan.md 작성 완료, 사용자 결정 필요 항목 있음 | "사용자 결정 필요 항목을 먼저 검토할까요?" |
| plan.md 작성 완료, 결정 항목 없음, 계획 복잡 | "독립 비평(layer1_critique)을 먼저 진행할까요? 새 스레드에서 약점을 찾아드립니다." |
| plan.md 작성 완료, 결정 항목 없음, 계획 단순 | "바로 구현을 진행할까요?" |
| 구현 완료 | "코드 검토를 진행할까요?" |
